...
function LiveAttackTableHead(props) {
...
const LiveAttackTableToolbar = (props) => {
...
LiveAttackTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
};

export default function LiveAttackTable() {
    ...
    <ThemeProvider theme={darkTheme}>
      <Box sx={{ width: '100%' }}>
        <Paper sx={{ width: '100%', mb: 2, backgroundColor: '#020000' }} elevation={8}>
          <LiveAttackTableToolbar numSelected={selected.length} />
          <TableContainer>
            <Table
              sx={{ minWidth: 750 }}
