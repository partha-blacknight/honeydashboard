...
function AttackIPTableHead(props) {
...
const AttackIPTableToolbar = (props) => {
...
AttackIPTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
};
    ...
    <ThemeProvider theme={darkTheme}>
      <Box sx={{ width: '100%' }}>
        <Paper sx={{ width: '100%', overflow: 'hidden', mb: 2, backgroundColor: '#020000' }} elevation={8}>
          <AttackIPTableToolbar numSelected={selected.length} />
